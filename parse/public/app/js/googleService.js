...
(function(window, angular, undefined) {
    ...
    var fields = "items(description,editable,iconLink,id, mimeType, properties,title,defaultOpenWithLink,alternateLink, parents(id,isRoot,kind), owners(displayName,picture), userPermission),  nextPageToken";
